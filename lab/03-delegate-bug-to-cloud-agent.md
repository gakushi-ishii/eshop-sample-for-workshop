...
### 2. Issue を作成して Cloud Agent に委託する

```text
検索に関する運用バグを、バグ報告テンプレート（.github/ISSUE_TEMPLATE/bug-report.md）に沿って GitHub Issue にしてください。
...
作成後、この Issue を Copilot Cloud Agent に割り当ててください。
Issue 番号と割り当て状態を報告してください。
```
