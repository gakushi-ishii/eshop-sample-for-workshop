...
Cloud Agent が検索バグの修正 PR を作成した。マージをする前に、Issue の受け入れ条件と PR の変更・テスト・CI を対応付けて人がレビューする。
...
GitHub Copilot App に戻り、PR を別セッションで開いて、Browser Canvas で `キャンプ テント` がヒットすることを確認する。

### 3. レビュー結果を返す

問題があれば、PR にコメントを投稿する。
